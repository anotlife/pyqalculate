...
_TYPE_NAMES: Dict[int, str] = {
    SHORTCUT_TYPE_FUNCTION: "Insert function",
    SHORTCUT_TYPE_VARIABLE: "Insert variable",
    SHORTCUT_TYPE_UNIT: "Insert unit",
    SHORTCUT_TYPE_TEXT: "Insert text",
    SHORTCUT_TYPE_CONVERT: "Convert to unit",
    SHORTCUT_TYPE_TO_NUMBER_BASE: "Convert to number base",
    SHORTCUT_TYPE_FACTORIZE: "Factorize result",
    SHORTCUT_TYPE_EXPAND: "Expand result",
    SHORTCUT_TYPE_RPN_UP: "RPN: up",
    SHORTCUT_TYPE_RPN_DOWN: "RPN: down",
    SHORTCUT_TYPE_RPN_SWAP: "RPN: swap",
    SHORTCUT_TYPE_RPN_COPY: "RPN: copy",
    SHORTCUT_TYPE_RPN_LASTX: "RPN: lastx",
    SHORTCUT_TYPE_RPN_DELETE: "RPN: delete register",
    SHORTCUT_TYPE_RPN_CLEAR: "RPN: clear stack",
    SHORTCUT_TYPE_META_MODE: "Load meta mode",
    SHORTCUT_TYPE_OUTPUT_BASE: "Set result base",
    SHORTCUT_TYPE_INPUT_BASE: "Set expression base",
    SHORTCUT_TYPE_EXACT_MODE: "Toggle exact mode",
    SHORTCUT_TYPE_DEGREES: "Set angle unit to degrees",
    SHORTCUT_TYPE_RADIANS: "Set angle unit to radians",
    SHORTCUT_TYPE_GRADIANS: "Set angle unit to gradians",
    SHORTCUT_TYPE_FRACTIONS: "Toggle simple fractions",
    SHORTCUT_TYPE_MIXED_FRACTIONS: "Toggle mixed fractions",
    SHORTCUT_TYPE_SCIENTIFIC_NOTATION: "Toggle scientific notation",
    SHORTCUT_TYPE_SIMPLE_NOTATION: "Toggle simple notation",
    SHORTCUT_TYPE_RPN_MODE: "Toggle RPN mode",
    SHORTCUT_TYPE_AUTOCALC: "Toggle calculate as you type",
    SHORTCUT_TYPE_PROGRAMMING: "Toggle programming keypad",
    SHORTCUT_TYPE_KEYPAD: "Show keypad",
    SHORTCUT_TYPE_HISTORY: "Show history",
    SHORTCUT_TYPE_HISTORY_SEARCH: "Search history",
    SHORTCUT_TYPE_CONVERSION: "Show conversion",
    SHORTCUT_TYPE_STACK: "Show RPN stack",
    SHORTCUT_TYPE_MINIMAL: "Toggle minimal window",
    SHORTCUT_TYPE_MANAGE_VARIABLES: "Manage variables",
    SHORTCUT_TYPE_MANAGE_FUNCTIONS: "Manage functions",
    SHORTCUT_TYPE_MANAGE_UNITS: "Manage units",
    SHORTCUT_TYPE_STORE: "Store result",
    SHORTCUT_TYPE_MEMORY_CLEAR: "MC (memory clear)",
    SHORTCUT_TYPE_MEMORY_RECALL: "MR (memory recall)",
    SHORTCUT_TYPE_MEMORY_STORE: "MS (memory store)",
    SHORTCUT_TYPE_MEMORY_ADD: "M+ (memory plus)",
    SHORTCUT_TYPE_MEMORY_SUBTRACT: "M- (memory minus)",
    SHORTCUT_TYPE_PLOT: "Open plot functions/data",
    SHORTCUT_TYPE_NUMBER_BASES: "Open convert number bases",
    SHORTCUT_TYPE_COPY_RESULT: "Copy result",
    SHORTCUT_TYPE_HELP: "Help",
    SHORTCUT_TYPE_QUIT: "Quit",
    SHORTCUT_TYPE_CHAIN_MODE: "Toggle chain mode",
    SHORTCUT_TYPE_DO_COMPLETION: "Show/hide completion",
    SHORTCUT_TYPE_ACTIVATE_FIRST_COMPLETION: "Perform completion",
    SHORTCUT_TYPE_INSERT_RESULT: "Insert result",
    SHORTCUT_TYPE_HISTORY_CLEAR: "Clear history",
    SHORTCUT_TYPE_PARENTHESES: "Insert parentheses",
}
...
class KeyboardShortcutManager:
    ...
    def get_shortcut_text(self, type_: int) -> str:
        ...
        return _TYPE_NAMES.get(type_, f"Action {type_}")
